...
const app = express();
mongoose.connect("mongodb://127.0.0.1/fitnessTracker")    
    .then(() => {
...
app.put('/update-entry/:id', (req, res) => {
    const updatedEntry = new DiaryEntryModel({_id: req.body.id, date: req.body.date, exercise: req.body.exercise, duration: req.body.duration, calories: req.body.calories })
...
app.post('/add-entry', (req, res, next) => {
    ...
    const diaryEntry = new DiaryEntryModel({date: req.body.date, exercise: req.body.exercise, duration: req.body.duration, calories: req.body.calories});
    diaryEntry.save()
        .then(() => {
            res.status(200).json({
